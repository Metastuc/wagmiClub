export const
    ...
    Hamburger = function () {
        return (
            <svg xmlns="http://www.w3.org/2000/svg" width={25} height={14} fill="none">
                <rect width={20} height={2} x={5} fill="#fff" rx={0.2} />
                <rect width={25} height={2} y={6} fill="#fff" rx={0.2} />
                <rect width={20} height={2} x={5} y={12} fill="#fff" rx={0.2} />
            </svg>
        );
    },
    ...
    Options = function () {
        return (
            <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} fill="none">
                <circle cx={12} cy={12} r={12} fill="#fff" fillOpacity={0.93} />
                <circle cx={7.5} cy={12.5} r={1.5} fill="#100F0F" fillOpacity={0.73} />
                <circle cx={11.5} cy={12.5} r={1.5} fill="#100F0F" fillOpacity={0.73} />
                <circle cx={15.5} cy={12.5} r={1.5} fill="#100F0F" fillOpacity={0.73} />
            </svg>
        );
    },
    ...
    Badge = function () {
        return (
            <svg xmlns="http://www.w3.org/2000/svg" width={11} height={12} fill="none">
                ...
                />
                <ellipse cx={5.499} cy={4.803} fill="#595959" rx={3.23} ry={2.968} />
                <mask
                    id="a"
                    width={7}
                    height={7}
                ...
                >
                    <ellipse cx={5.672} cy={5.12} fill="#C28B37" rx={3.237} ry={2.975} />
                </mask>
                <g mask="url(#a)">
                    <ellipse cx={5.501} cy={4.803} fill="url(#b)" rx={3.237} ry={2.975} />
                </g>
                <path
                    fill="url(#c)"
