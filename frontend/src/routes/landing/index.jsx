...
import { Club, Profile } from "../../components";
import { PrimaryNavbar as Navbar } from "../../views";
import "./index.scss";
		...
		<section className="landing">
			...
			<section className="hero">
				<div className="hero-wrapper">
					<h1>the club with the magic door</h1>

					<p>
						wagmi<span>club</span> is an onchain social platform for
						web3 humans to build reputation
					</p>
				</div>
